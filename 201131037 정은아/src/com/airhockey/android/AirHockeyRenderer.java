...
import com.airhockey.android.objects.GoalPost;
...
public class AirHockeyRenderer implements Renderer {    
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        goalpost = new GoalPost(0.5f, 0.25f, 0.05f); 
        desk = new Desk(0.8f, 0.5f, 0.05f);
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        // Draw the Goalpost;
        positionObjectInScene(0f, 0.12f, 0.8f);
        colorProgram.setUniforms(modelViewProjectionMatrix, 1f, 1f, 0f);
        goalpost.bindData(colorProgram);
        //goalpost.draw();
        
        positionObjectInScene(0f, 0.12f, -0.8f);
        colorProgram.setUniforms(modelViewProjectionMatrix, 0f, 1f, 1f);
        goalpost.bindData(colorProgram);
        goalpost.draw();
        
        positionObjectInScene(0f, 0f, 0f);
        //textureProgram.useProgram();
        textureProgram.setUniforms(modelViewProjectionMatrix, texture_wood);
